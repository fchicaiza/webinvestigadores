...
<body>
  <section class="menu cid-rCDdOSsIMS" once="menu" id="menu2-z">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="../index.php">
                        <img src="../assets/images/logo-408x157.png" alt="Seguros" title="" style="height: 6.1rem;">
                    </a>
                </span>
    ...
    </section><section class="mbr-section content4 cid-rCDdOTjrA0" id="content4-10">
        ...
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-6">
                    <strong>¿Fraude con la companía aseguradora?</strong></h2>
        ...
        <div class="row justify-content-center">
            <div class="media-container-column title col-12 col-md-10">
                <h2 class="align-left mbr-bold mbr-white pb-3 mbr-fonts-style display-2">
                    Área de seguros</h2>
                <h3 class="mbr-section-subtitle align-left mbr-light mbr-white pb-3 mbr-fonts-style display-5"><em>Servicio de Investigación orientado a Compañías Aseguradoras, mediante la cual se establece las circunstancias en las cuales se produjo el siniestro, realizada la pericia y con la evidencia obtenida de ser el caso se lo puede atribuir a circunstancias fortuitas &nbsp;y de no ser así, se demuestra de manera fehaciente la participación del asegurado en el siniestro, con la intención de beneficiarse ilícitamente del seguro, investigación para todos los ramos.</em></h3>
